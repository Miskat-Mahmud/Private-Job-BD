...
import com.jobapp.inttechlimited.BuildConfig;
...
public class Constant implements Serializable {
    ...
    public static String bannerAdType, interstitialAdType;
    public static String bannerId, interstitialId, adMobPublisherId, wortiseAppId;
